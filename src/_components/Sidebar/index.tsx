...
import {useIsMobile} from "@/_utils/use-is-mobile";
...
const sidebarMenuButtonVariants = tv({
  base: [
    ...
    "data-[active=false]:text-grey-500 font-bold data-[active=true]:bg-transparent data-[active=true]:text-white",
  ...
  variants: {
    ...
    size: {
      default: "h-8 text-base font-bold font-dm-sans",
      sm: "h-7 text-xs",
